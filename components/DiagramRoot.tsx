    ...
    <div className="flex flex-col h-full relative" onClick={closeDropdowns}>
      ...
      {activeTab === "graph" && (
        <>
          ...
          <div className="relative flex-1">
            ...
            {/* Panneau détail */}
            <div className="absolute z-10 inset-x-2 bottom-2 top-auto max-h-[60vh] md:inset-x-auto md:right-12 md:top-4 md:bottom-4 md:max-h-none overflow-y-auto">
      ...
      <div className={activeTab === "map"
        ...
        <div className="relative flex flex-1 overflow-hidden">
          ...
          />
          <div className="absolute z-[1000] inset-x-2 bottom-2 top-auto max-h-[60vh] md:inset-x-auto md:right-4 md:top-4 md:bottom-4 md:max-h-none overflow-y-auto">
      ...
      {activeTab === "table" && (
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="relative flex flex-1 overflow-hidden">
            ...
            <div className="absolute z-10 inset-x-2 bottom-2 top-auto max-h-[60vh] md:inset-x-auto md:right-4 md:top-4 md:bottom-4 md:max-h-none overflow-y-auto">
              {selectedNode && <DetailCardRoot node={selectedNode} onClose={() => setSelectedNode(undefined)} />}
            </div>
          </div>
        </div>
